...
class tests(unittest.TestCase):
	...
	def test_image_operations(self):
		...
		self.imgProcessor.saturation_mod_value = 200
		self.imgProcessor.saturation_exec()
		...
		self.imgProcessor.put_marker_exec()
		self.imgProcessor.marker_mod_values = (100, 100, 10, 2, 1, 255, 255, 255)
		self.imgProcessor.put_marker_exec()
		self.imgProcessor.marker_mod_values = (100, 100, 10, 3, 1, 255, 255, 255)
		self.imgProcessor.put_marker_exec()
		self.imgProcessor.marker_mod_values = (100, 100, 10, 1, 2, 255, 255, 255)
		self.imgProcessor.put_marker_exec()
		self.imgProcessor.marker_mod_values = (100, 100, 10, 2, 2, 255, 255, 255)
		self.imgProcessor.put_marker_exec()
		self.imgProcessor.marker_mod_values = (100, 100, 10, 3, 2, 255, 255, 255)
		self.imgProcessor.put_marker_exec()

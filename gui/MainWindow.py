...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOdwr_kolory = QtGui.QAction(MainWindow)
        self.actionOdwr_kolory.setObjectName(_fromUtf8("actionOdwr_kolory"))
        ...
        self.actionSave.triggered.connect(self.show_save_message)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOdwr_kolory.setText(_translate("MainWindow", "Odwróć kolory", None))
    ...
    def show_save_message(self):
        save_msg = QtGui.QMessageBox.question(None, 'Stan zapisu', 'Zapisano pomyslnie' ,QtGui.QMessageBox.Ok)

    def show_save_as_dialog(self):
        savepath = QtGui.QFileDialog.getOpenFileName(None, 'Otworz', '', 'All Files (*.*);;jpeg (*.jpeg);;jpg (*.jpg);;png (*.png)')

        if savepath:
            # self.open(filename) - ma zapisac
            msg = QtGui.QMessageBox.question(None, 'Sciezka zapisu', str(savepath),QtGui.QMessageBox.Ok)
